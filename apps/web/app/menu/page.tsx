                            ...
                            {category.items.map((item, itemIndex) => (
                                ...
                                >
                                    <div className="flex gap-4">
                                        {/* Image */}
                                        <div className="w-28 h-28 bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl flex-shrink-0 overflow-hidden group-hover:ring-2 ring-emerald-500/30 transition-all">
                                            {item.image_url ? (
                                                <img
                                                    src={item.image_url}
                                                    alt={item.name}
