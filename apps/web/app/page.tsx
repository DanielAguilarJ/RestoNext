...
import { DashboardProvider, DateRangeSelector } from "@/app/analytics/DashboardContext";
                ...
                >
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                            ...
                            {/* Analytics */}
                            <Link href="/analytics" className="group relative overflow-hidden rounded-xl border bg-white dark:bg-zinc-900 p-4 hover:border-indigo-500 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/10">
                                ...
                                <div className="relative z-10">
                                    <div className="w-10 h-10 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg flex items-center justify-center mb-3 text-indigo-600 dark:text-indigo-400 group-hover:scale-110 transition-transform">
                                        <BarChart3 className="w-5 h-5" />
                                    </div>
                                    <h4 className="font-semibold text-gray-900 dark:text-white">Analytics</h4>
                                    <p className="text-xs text-gray-500 mt-1">Reportes BI</p>
                                </div>
                            </Link>
                        </div>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4">
                            ...
                            {/* Admin */}
                            <Link href="/admin" className="group relative overflow-hidden rounded-xl border bg-white dark:bg-zinc-900 p-4 hover:border-gray-500 transition-all duration-300 hover:shadow-lg hover:shadow-gray-500/10">
                                ...
                                <div className="relative z-10">
                                    <div className="w-10 h-10 bg-gray-100 dark:bg-gray-800 rounded-lg flex items-center justify-center mb-3 text-gray-600 dark:text-gray-400 group-hover:scale-110 transition-transform">
...
export default function Home() {
    return (
        <QueryClientProvider client={queryClient}>
            <DashboardProvider defaultPreset="last_7_days" defaultComparisonMode="previous_period">
